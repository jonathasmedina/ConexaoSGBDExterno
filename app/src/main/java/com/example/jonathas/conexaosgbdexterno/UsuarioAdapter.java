...
public class UsuarioAdapter extends ArrayAdapter<Usuario> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView textView = (TextView) convertView.findViewById(R.id.nome);
        textView.setText(itemPosicao.getNome());

        TextView textViewEmail = (TextView) convertView.findViewById(R.id.email);
        textViewEmail.setText(itemPosicao.getEmail());

        TextView textViewTelefone = (TextView) convertView.findViewById(R.id.telefone);
